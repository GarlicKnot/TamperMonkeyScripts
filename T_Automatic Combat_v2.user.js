...
function combat( ) {
    ...
    ///check mana potion number
    ///Get count of mana potions remaining
    var potion2string = $('#combat_details > div > div.panel-footer > div > div:nth-child(1) > div > div > button:nth-child(2)').text();
    var potion2count  = potion2string.replace(/[^0-9]/g,'');
    ...
    } else if ((enemydata === "Gecko" || enemydata === "Bee" || enemydata ==="Crab") && potion2count > 0) {
      WithMana();
    } else if ((enemydata === "Gecko" || enemydata === "Bee" || enemydata ==="Crab") && potion2count < 1) {
      WithoutMana();
